...
function _sandbox_init(_ENV) -- ignore -------------------------------------
    ...
    function bots_simple(params)
        ...
        -- CALL GET EVAL FUNCTION AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
        getEval(G, G[USER])
        ...
        local from =
            ...
            planets,
            function(o)
                if o.owner == USER and o.ships >= 15 then
                    return o.ships
                end
            end
        )
...
bots_register("simpleCopy1", "bots_simple", {percent = 50})
bots_register("simpleCopy2", "bots_simple", {percent = 50})
